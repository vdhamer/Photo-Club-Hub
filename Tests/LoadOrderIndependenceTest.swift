...
// Level 0, Level 1 and the 14 Level 2 loads ran concurrently. LevelLoader.loadAllLevels() in the Photo Club
// Hub Data package has since introduced the ordering — it awaits Level 0, then Level 1, then runs the Level 2
// loaders in a TaskGroup, and the package tests assert that ordering directly (Data#12) — but this
