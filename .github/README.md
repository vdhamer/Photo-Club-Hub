...
- **Optional** fields (that are used)
    ...
    - `photographerImage` is a portrait showing the photographer. We may add an extra mode whereby an image of the photographer is shown instead of the currently shown featured image.
