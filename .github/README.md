...
For Photo Club Waalre, the _membership list_ is read from an HTML table on a
...
using a long key and a Wordpress plugin. The Github version uses a (redacted) copy of the membership list in order
to show real data. The details about this can be found above.
