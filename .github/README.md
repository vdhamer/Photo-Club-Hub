...
Similarly, a club can store their list of `Images` per member (`MemberPortfolio`) in any
conceivable format and again leaves it up to the software module to do the conversion.
...
in a web page that can also be directly displayed in a brower.
