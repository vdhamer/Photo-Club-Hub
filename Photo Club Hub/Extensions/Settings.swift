...
struct Settings {
    ...
    static let userDefaultsKey: String = "dataResetPending282b4647" // must match id of Settings toggle in Root.plist
    private static let prevUserDefaultsKeys: Set<String> = ["dataResetPending282b4646",
