...
struct Settings {
    ...
    static let userDefaultsKey: String = "dataResetPending288b4654" // must match id of Settings toggle in Root.plist
    private static let prevUserDefaultsKeys: Set<String> = ["dataResetPending286b4652",
