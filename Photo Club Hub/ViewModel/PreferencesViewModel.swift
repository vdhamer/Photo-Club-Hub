...
class PreferencesViewModel: ObservableObject {
    ...
    @Published("preferences", cancellableSet: &cancellableSet) // @Published only works on classes
...
struct PreferencesStruct { // order in which they are shown on Preferences page
    ...
    var showPhotographerImage: Bool
...
extension PreferencesStruct: Codable { // this extension was generated by GPT (and was needed for SemanticColor?)
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case showPhotographerImage // Bool
    }
