...
<details><summary><h3>The Level2.json format</h3> (click to expand)</summary></p>
...
<details><summary>Fields in level2.json format about members (click to expand)</summary></p>
