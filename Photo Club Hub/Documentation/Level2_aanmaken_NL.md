...
en [Photo Club Hub HTML](https://github.com/vdhamer/Photo-Club-Hub-HTML) apps. Daarom zijn er vereisten wat betreft het formaat ("Level 2").
...
2. Maak een **kopie** van het [Min](https://github.com/vdhamer/Photo-Club-Hub/blob/main/JSON/xampleMin.level2.json) bestand en geef het een passende bestandsnaam:
   ...
   > Verderop staat hoe je dat automatisch kan controleren: JSON is kieskeurig over haakjes en comma's.
