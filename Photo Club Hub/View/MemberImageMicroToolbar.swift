...
struct MemberImageMicroToolbar: View {
    ...
    @State var flipImageFlag: Bool
    var preferenceForFeaturedImage: Bool
    let squareSize: CGFloat
    let receivedCaption: AnyView?

    init(member: MemberPortfolio,
         wkWebView: WKWebView,
         flipImageFlag: Bool,
         preferenceForFeaturedImage: Bool,
         squareSize: CGFloat,
         caption receivedCaption: AnyView?) {
        self.member = member
        self.wkWebView = wkWebView
        self.flipImageFlag = flipImageFlag
        self.preferenceForFeaturedImage = preferenceForFeaturedImage
        self.squareSize = squareSize
        self.receivedCaption = receivedCaption
    }
    ...
    struct Wrapper: View {
        ...
        var body: some View {
            MemberImageMicroToolbar(member: member,
                                    ...
                                    squareSize: 80,
                                    caption: AnyView( Text(verbatim: "Here is a caption") )
            )
                .padding()
        }
    }
